...
public class UmbrellaHealthUp : MonoBehaviour {

	// Public Variables
	[Tooltip("How much health will be recovered for the player's umbrella")]
	...
	private void OnTriggerEnter(Collider other) {
		if(other.gameObject.tag == "Player")
		{
			...
			pCtrl.Umbrella.ModifyUmbrellaHP(healthToRecover);
			powerupCollider.enabled = false;
			powerupMesh.enabled = false;
			if (!respawnOnlyOnce)
