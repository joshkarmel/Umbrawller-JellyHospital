...
public class Umbrella_Net : NetworkBehaviour {

//------------------------------------------------------------------------CONSTANTS:

	private const string LOG_TAG = "Umbrella_Net";
	...
	public PlayerController_Net playerControllerNet;
...
//--------------------------------------------------------------------------METHODS:
	...
	public void ModifyUmbrellaHP(float HpChange)
	{
		...
		if (newHP < 0)
		{
			HitPoints = 0;
			CloseUmbrella();
			playerControllerNet.CanUseUmbrella = false;
		}
	...
	public void ActivateShield()
	{
		...
		UmbrellaObject.transform.Rotate(90f, 0f, 0f);
	}
